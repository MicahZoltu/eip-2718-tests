...
export function rlpEncodeBigint(value: bigint) {
	return stripLeadingZeros(unsignedIntegerToUint8Array(value, 32))
}

export function rlpEncodeAddress(value: bigint) {
	return stripLeadingZeros(unsignedIntegerToUint8Array(value, 20))
}
